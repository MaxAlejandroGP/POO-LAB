            ...
            switch(opc){
                ...
                case 4:
                    if(bandera==1){
                        ...
                        switch(opcv){
                            case 1:
                                for(Animal animal: zoo.listaDeAnimales){
                                    veterinario.vacuna(animal,zoo.listaDeAnimales.size());
                                }
                            break;

                            case 2:
                                for(Animal animal: zoo.listaDeAnimales){
                                    veterinario.verificarEdad(animal,zoo.listaDeAnimales.size());
                                }
                            break;

                            case 3:
                                for(Animal animal: zoo.listaDeAnimales){
                                    veterinario.habilitarComidaAdulta(animal,zoo.listaDeAnimales.size());
                                }
                            break;
